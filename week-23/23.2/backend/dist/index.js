...
let senderSocket = null; // to store the sender socket, cache them globally
let receiverSocket = null; // to store the receiver socket, cache them globally
wss.on("connection", function connection(ws) {
    ...
    ws.on("message", function message(data) {
        ...
        if (message.type === "identify-as-sender") {
            ...
            receiverSocket === null || receiverSocket === void 0 ? void 0 : receiverSocket.send(JSON.stringify({ type: "answer", offer: message.offer }));
